...
export default function Login() {
  ...
  return (
    <div style={{
      ...
      background: '#F7F5F2', padding: 32, textAlign: 'center'
    }}>
      <div style={{
      ...
      <p style={{ fontSize: 15, color: '#aaa', marginBottom: 48, lineHeight: 1.6 }}>
        Registrá y controlá<br />tus movimientos fácilmente
      </p>
      ...
      <button onClick={loginConGoogle} style={{
        ...
        boxShadow: '0 3px 0px #e0ddd8, 0 4px 12px rgba(0,0,0,0.06)',
