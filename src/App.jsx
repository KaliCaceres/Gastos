...
export default function App() {
  ...
  function cambiarMes(m, a) { setMesFiltro(m); setAnioFiltro(a) }
  ...
  useEffect(() => { if (usuario) cargarMovimientos() }, [usuario])
  ...
  return (
    <div style={{ width: '100%', height: '100vh', background: '#1A3C34', display: 'flex', flexDirection: 'column', position: 'relative' }}>
      ...
      {/* Botón config — flotante, no ocupa espacio */}
      ...
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        {pantalla === 'lista' && movEditando && (
          <Formulario
            ...
            onGuardar={async (datos) => { await editarMovimiento(movEditando.id, datos); setMovEditando(null) }}
